...
<body>
<form  method="get" action="view-form input data.php" class="container border border-primary bg-success">
  <div class="form-row">
  ...
  <div class="form-group">
    ...
    <input type="text" name="address2" required class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
